...
class GroupInfo extends StatefulWidget {
  ...
  const GroupInfo({required this.groupId, required this.groupName, Key? key, required String adminName})
      : super(key: key);
  ...
  Future onLeaveGroup() async {
    if (true)//!checkAdmin())
    {
      ...
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (_) => ChatLayout()),//HomeScreen()
        (route) => false,
      );
    }
  }
            ...
            true
                        ? ListTile(
                            onTap: () => Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (_) => ChatGroupAddMemberScreen(widget.groupId, widget.groupName)/*AddMembersINGroup(
